                            ...
                            <div class="client-detail">
                                ...
                                <div class="client-contain">
                                    ...
                                    <a href="#!" class="text-muted">
                                        <h6><?php echo $data_lengkap->nama_kelas ?> Absen : (<?php echo $data_lengkap->siswa_nomorabsen ?>)</h6>
                                    </a>
                                ...
                                <div class="client-card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-center p-10">
                                            <p class="text-muted m-0 font-weight-bolder">ID Atlet</p>
                                                ...
                                                <tbody>
                                                    <?php foreach ($data_kasus as $data_kasussiswa) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><strong style="color:blue;"><a class="btn btn-sm btn-danger" href="https://api.whatsapp.com/send/?phone=6285876076005&text=Saya%20ingin%20membayar%20tagihan%20yang%20di%20dashboard" target="_blank" rel="noopener noreferrer">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="carousel-inner text-center">
                        ...
                        </div>                        <div class="carousel-item" data-interval="50000">
