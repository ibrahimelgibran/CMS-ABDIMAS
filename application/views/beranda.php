...
<head>
    ...
    <meta property="og:url" content="https://www.iegcode.coom">
...
<body class="   hs-content-id-39403979750 hs-landing-page hs-page " style="">
            ...
            <div class="row-fluid-wrapper row-depth-1 row-number-1">
                <div class="row-fluid">
                    <div class="span12 widget-span widget-type-custom_widget" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                        <div id="hs_cos_wrapper_module_164015251670411" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                            <link rel="stylesheet" href="<?php echo base_url() ?>assets/beranda/bootstrap.min.css">
                            ...
                            <script>
                                document.getElementById("services").addEventListener("click", function() {
                                    var dropdown = document.getElementById("services_item");
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .navigation__content {
                display: none;
                /* Hide content on small screens by default */
                flex-direction: column;
                width: 100%;
                margin-top: 10px;
            }
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (hamburgerIcon) {
                hamburgerIcon.addEventListener("click", function() {
                    const isExpanded = navigationContent.classList.contains("show");
                    navigationContent.classList.toggle("show", !isExpanded);
                });
            }
        });
    </script>
    ...
    <div class="body-container-wrapper">
        <div class="body-container container-fluid">
            ...
            <div class="row-fluid-wrapper row-depth-1 row-number-1 ">
                <div class="row-fluid ">
                    <div class="span12 widget-span widget-type-custom_widget " style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                        <div id="hs_cos_wrapper_module_1649750487057153" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                                ...
                                <div class="page-center">
                                    <div class="container-notif">
                                        <div class="text-notif">
                                            <a href="#">
                                                <p class="font-notif">
                                                    <marquee><?php echo $res->pesanberjalan; ?></marquee>
                                                </p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="container-hero">
                                        <div class="hero__left">
                                            ...
                                            <div class="wrapping-button-hero">
                                                ...
                                                &nbsp;&nbsp;&nbsp;
                                                <a href="loginguru"><button class="btn-banding-paket">Login Akun Coach
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url() ?>assets/beranda/image/carbon_arrow-right.svg" alt="arrow"></button>
                                                </a>
                                            </div>
      ...
      <img src="<?php echo base_url() ?>assets/beranda/image/nextaktif.svg" class="aktif">
            ...
            <div class="row-fluid-wrapper row-depth-1 row-number-2 ">
                <div class="row-fluid ">
                    <div class="span12 widget-span widget-type-custom_widget " style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                        <div id="hs_cos_wrapper_module_1649651296448188" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                            <style>
                            </style>
                                        ...
                                        <div class="boxleft-benefits">
                                            ...
                                            <div class="boxleft-item-wrap">
                                                <div class="boxleft-item">
                                                    <img src="https://img.freepik.com/free-photo/high-view-elderly-couple-wearing-roller-skates_23-2148509209.jpg" alt="icon video belajar adaftif">
                                                    <p>
                                                        Kebutuhan Peralatan
                                                    </p>
                                                </div>
                                                <div class="boxleft-item">
                                                    <img src="https://img.freepik.com/free-vector/group-medical-staff-carrying-health-related-icons_53876-43071.jpg?" alt="icon Kuis di tiap video">
                                                    <p>
                                                        Kesehatan Fisik
                                                    </p>
                                                </div>
                                                ...
                                                <!-- <div class="boxleft-item">
              <img src="https://img.freepik.com/free-vector/group-medical-staff-carrying-health-related-icons_53876-43071.jpg?" alt="icon Rangkuman &amp; infografik">
              <p>
                Semangat 
              </p>
            </div>
            ...
            <div class="row-fluid ">
                <div class="span12 widget-span widget-type-custom_widget " style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                    <div id="hs_cos_wrapper_module_1649651718954246" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                        ...
                        <script src="<?php echo base_url() ?>assets/beranda/jquery.min.js"></script>
                        <script src="https://www.ruangguru.com/hs-fs/hub/2828691/hub_generated/template_assets/10729457848/1615619794843/Templates/Custom/Page/Fadhli/All_Template_for_Marketing_Engineer/Source_Modal_Video/modal-video.js"></script>
                        <script src="https://www.ruangguru.com/hs-fs/hub/2828691/hub_generated/template_assets/10729457994/1615619961343/Templates/Custom/Page/Fadhli/All_Template_for_Marketing_Engineer/Source_Modal_Video/jquery-modal-video-min.js"></script>
                        <script src="<?php echo base_url() ?>assets/beranda/slick.min.js"></script>
                    </div>
        ...
        <!-- <div class="container text-center">
            ...
            <div class="logo-container mt-4">
                <div class="logo">
                    <img src="<?php echo base_url() . 'assets/images/iegcode.png' ?>" alt="iegcode" />
                    <img src="<?php echo base_url() . 'assets/images/iegcode.png' ?>" alt="iegcode" />
                    <img src="<?php echo base_url() . 'assets/images/iegcode.png' ?>" alt="iegcode" />
                    <img src="<?php echo base_url() . 'assets/images/iegcode.png' ?>" alt="iegcode" />
                    <img src="<?php echo base_url() . 'assets/images/iegcode.png' ?>" alt="iegcode" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <h6>About</h6>
                        <p class="text-justify">Kursus sepatu roda yang berdedikasi untuk mengembangkan <br /> kemampuan dan keterampilan dalam olahraga sepatu roda.</p>
                    </div>
                    <div class="col-6 col-md-3">
                        <h6>Categories</h6>
                        <ul class="footer-links ">
                            <li><a href="#">Pelatihan Profesional</a></li>
                            <li><a href="#">Acara dan kompotisi</a></li>
                            <li><a href="#">Program Pengembangan Diri</a></li>
                            <li><a href="#">Komunitas yang Solid</a></li>
                        </ul>
                    </div>
                    <div class="col-6 col-md-3">
                        <h6>Quick Links</h6>
